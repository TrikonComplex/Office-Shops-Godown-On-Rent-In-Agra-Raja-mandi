...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "godown on rent in Agra",
    "godown for rent near me",
    "warehouse for rent in Agra",
    ...
    "shop for rent near me",
    "small shop for rent",
    "furnished shop for rent Agra",
    "furnished office for rent Agra",
    "cheap shop for rent Agra",
    "shop for rent low budget",
    "commercial space for rent near me",
    "prime location for shop in Agra",
    "best location for shop in Agra",
    "high footfall shop Agra",
    "main market shop for rent",
    "shop for rent in busy market Agra",
    "startup ideas in Agra",
    "small business ideas in Agra",
    "new business ideas low investment",
    "shop business ideas India",
    "best business to start in Agra",
    "boutique shop for rent",
    "salon shop for rent",
    "garment shop for rent Agra",
    "pharmacy shop for rent Agra",
    "electronics shop for rent Agra",
    "stationery shop for rent",
    "home decor shop for rent",
    "paint shop for rent",
    "CA office for rent Agra",
    "coaching centre space for rent Agra",
    "tattoo studio space for rent",
    "coworking space Agra",
    "shop near Taj Mahal tourist market",
    "shop for foreign tourists Agra",
  ],
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Furnished shops start from ₹2,800 per month. Exact rent depends on floor, size and intended use of the unit. Standard security deposit is 3 to 6 months of rent. Final terms are discussed directly with the owner — call +91 88392 69122 for current pricing.",
          },
        },
        {
          "@type": "Question",
          name: "What are good startup ideas for a shop in Raja Mandi Agra?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Businesses that benefit from daily bazaar footfall do well here: boutique or garment stores, salons, pharmacies, electric and hardware shops, fancy lighting shops, stationery shops, gift and home décor shops, paint studios, and tattoo studios. Upper-floor units also suit CA offices, coaching centres, and startup or coworking offices.",
          },
        },
        {
          "@type": "Question",
          name: "Is Raja Mandi a prime location for a shop in Agra?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes. Raja Mandi is one of Agra's oldest and busiest commercial markets, close to Raja Ki Mandi railway station, with steady daily footfall and proximity to the Taj Mahal tourist circuit, making it a prime location for retail and professional businesses in Agra.",
          },
        },
        {
          "@type": "Question",
